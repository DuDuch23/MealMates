...
//                 $photoPath = '/public/uploads/offers-photos/' . $photo; // Remplace par un chemin réel
//                 $photos[] = new File($photoPath);
//             }
//             $offer->setPhotosFileOffers($photos); // Appel de la méthode définie dans l'entité

//             // Récupérer un utilisateur aléatoire
//             $user = $this->getReference('user_' . rand(0, 1), User::class); // Utilisation correcte de getReference
//             $offer->setUser($user);
