 ...
 */
final class Version20250506063501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE offer ADD is_vegan TINYINT(1) NOT NULL, ADD latitude DOUBLE PRECISION DEFAULT NULL, ADD longitude DOUBLE PRECISION DEFAULT NULL, DROP photos_name_offer
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user ADD icon_user INT DEFAULT NULL, ADD adress VARCHAR(255) DEFAULT NULL, ADD is_verified TINYINT(1) DEFAULT 0 NOT NULL, ADD verification_token VARCHAR(255) DEFAULT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE offer ADD photos_name_offer JSON DEFAULT NULL COMMENT '(DC2Type:json)', DROP is_vegan, DROP latitude, DROP longitude
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE user DROP icon_user, DROP adress, DROP is_verified, DROP verification_token
        SQL);
    }
}
