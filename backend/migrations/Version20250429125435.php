 ...
 */
final class Version20250429125435 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE image ADD link VARCHAR(255) NOT NULL, ADD updated_at DATETIME NOT NULL, DROP offer_id, CHANGE filename name VARCHAR(255) NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE image ADD offer_id INT NOT NULL, ADD filename VARCHAR(255) NOT NULL, DROP name, DROP link, DROP updated_at
        SQL);
        $this->addSql(<<<'SQL'
