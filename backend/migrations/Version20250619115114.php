 ...
 */
final class Version20250619115114 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE offer DROP is_vegan
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE `order` ADD is_confirmed TINYINT(1) NOT NULL, ADD expires_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)'
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE offer ADD is_vegan TINYINT(1) NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE `order` DROP is_confirmed, DROP expires_at
        SQL);
        $this->addSql(<<<'SQL'
